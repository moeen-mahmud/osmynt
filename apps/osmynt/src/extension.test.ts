import { describe, it, expect, spyOn, mock, type jest } from "bun:test";
...
describe("extension", () => {
	describe("activation", () => {
		it("registers the hello world command", () => {
			...
			const command = (vscode.commands.registerCommand as jest.Mock).mock.calls[0][0];
			const callback = (vscode.commands.registerCommand as jest.Mock).mock.calls[0][1] as any as () => void;
