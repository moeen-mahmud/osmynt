...
export const guideSteps = [
	...
	},
	{
		...
		description: "Enter your name and email to simulate GitHub authentication.",
	...
	},
	{
		...
		description:
			"Great! Bob has joined your team. Now select some code blocks in your editor to share with him. You can click and drag to select text, or click on line numbers to select entire lines.",
	...
	},
	{
		...
		description:
			"Perfect! You've selected code blocks. Now share it with Bob by clicking the 'Share Code' button that appears below the editor.",
	...
	},
	{
		title: "Apply Changes",
		description:
			"Bob can now apply your shared code to his editor using Git-like diff application. For now, you control the changes applied to Bob's editor.",
	...
	},
	{
		...
		action: "Try navigating to Bob's editor and see the changes applied to his editor",
