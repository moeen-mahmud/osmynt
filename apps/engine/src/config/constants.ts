export const OSMYNT_KEYS = "osmynt:keys";
export const OSMYNT_PAIR = "osmynt:pair";
...
export const GITHUB_ACCEPT_APPLICATION_JSON = "application/vnd.github.v3+json";
...
export const SUPABASE_CHANNEL_ERROR = "CHANNEL_ERROR";
export const SUPABASE_CHANNEL_SUBSCRIBED = "SUBSCRIBED";
